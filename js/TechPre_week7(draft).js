...
document.addEventListener('DOMContentLoaded', function() {
    const uuidElement = document.getElementById('data-container');
    const uuid = uuidElement.getAttribute('data-uuid'); // Correctly accessing the UUID
    ...
    .then(xmlData => {
        ...
        const stringElement = xmlDoc.querySelector('identification > label ');
        if (stringElement) {
        ...
        function updateImages(xmlDoc){
            const imageElements = `${baseURL}${uuid}&load`
